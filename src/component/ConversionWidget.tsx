    ...
    >
      ...
      <div className="flex flex-col gap-4 mb-6">
        ...
        <div className="relative z-30">
          <AmountInput
            ...
            onCurrencyClick={() =>
              setActiveDropdown(
                activeDropdown === "receiveCurrency" ? null : "receiveCurrency"
              )
            }
          />
      ...
      <div className="relative z-20">
        <SelectInput
          ...
          onClick={() =>
            setActiveDropdown(activeDropdown === "payFrom" ? null : "payFrom")
          }
          value={
      ...
      <div className="relative z-10">
        <SelectInput
          ...
          value={selectedPayTo ? renderWalletValue(selectedPayTo) : undefined}
          error={errors.payTo}
        />
